...
const ProviderSourceSchema = Yup.object().shape({
  //Generated by GetAllFieldValidationBySeqModel
name: Yup.string().required("Name is a required field."),
  
});

const ProviderSourceArraySchema = Yup.object().shape({
  ProviderSources: Yup.array().of(
    Yup.object().shape({
...
export { ProviderSourceSchema, ProviderSourceArraySchema };
