...
import { StatusFormikFilter } from "@/interfaces/StatusInterfaces";
import { convertDateToYYYYMMDD } from "@/utils/utilities";

export const MODEL_NAME = "Status";
export const TABLE_NAME = "status";
export const PLURALIZED_MODEL_NAME = "Status";
export const VERBOSE_MODEL_NAME = "Status";
export const PLURALIZED_VERBOSE_MODEL_NAME = "Status";
export const DEFAULT_SORT_BY = "name";
export const DEFAULT_FILTERS: Partial<StatusFormikFilter> = { 
