...
import { PlacementStatusFormikFilter } from "@/interfaces/PlacementStatusInterfaces";
import { convertDateToYYYYMMDD } from "@/utils/utilities";

export const MODEL_NAME = "PlacementStatus";
export const TABLE_NAME = "placement_status";
export const PLURALIZED_MODEL_NAME = "PlacementStatus";
export const VERBOSE_MODEL_NAME = "Placement Status";
export const PLURALIZED_VERBOSE_MODEL_NAME = "Placement Status";
export const DEFAULT_SORT_BY = "name";
export const DEFAULT_FILTERS: Partial<PlacementStatusFormikFilter> = { 
