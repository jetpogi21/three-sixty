...
import { ProviderTypeFormikFilter } from "@/interfaces/ProviderTypeInterfaces";
import { convertDateToYYYYMMDD } from "@/utils/utilities";

export const MODEL_NAME = "ProviderType";
export const TABLE_NAME = "provider_types";
export const PLURALIZED_MODEL_NAME = "ProviderTypes";
export const VERBOSE_MODEL_NAME = "Provider Type";
export const PLURALIZED_VERBOSE_MODEL_NAME = "Provider Types";
export const DEFAULT_SORT_BY = "name";
export const DEFAULT_FILTERS: Partial<ProviderTypeFormikFilter> = { 
