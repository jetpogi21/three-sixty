...
import { PositionFormikFilter } from "@/interfaces/PositionInterfaces";
import { convertDateToYYYYMMDD } from "@/utils/utilities";

export const MODEL_NAME = "Position";
export const TABLE_NAME = "positions";
export const PLURALIZED_MODEL_NAME = "Positions";
export const VERBOSE_MODEL_NAME = "Position";
export const PLURALIZED_VERBOSE_MODEL_NAME = "Positions";
export const DEFAULT_SORT_BY = "name";
export const DEFAULT_FILTERS: Partial<PositionFormikFilter> = { 
