...
import { DivisionFormikFilter } from "@/interfaces/DivisionInterfaces";
import { convertDateToYYYYMMDD } from "@/utils/utilities";

export const MODEL_NAME = "Division";
export const TABLE_NAME = "divisions";
export const PLURALIZED_MODEL_NAME = "Divisions";
export const VERBOSE_MODEL_NAME = "Division";
export const PLURALIZED_VERBOSE_MODEL_NAME = "Divisions";
export const DEFAULT_SORT_BY = "name";
export const DEFAULT_FILTERS: Partial<DivisionFormikFilter> = { 
