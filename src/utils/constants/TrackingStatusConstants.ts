...
import { TrackingStatusFormikFilter } from "@/interfaces/TrackingStatusInterfaces";
import { convertDateToYYYYMMDD } from "@/utils/utilities";

export const MODEL_NAME = "TrackingStatus";
export const TABLE_NAME = "tracking_status";
export const PLURALIZED_MODEL_NAME = "TrackingStatus";
export const VERBOSE_MODEL_NAME = "Tracking Status";
export const PLURALIZED_VERBOSE_MODEL_NAME = "Tracking Status";
export const DEFAULT_SORT_BY = "name";
export const DEFAULT_FILTERS: Partial<TrackingStatusFormikFilter> = { 
