...
import { ProviderSourceFormikFilter } from "@/interfaces/ProviderSourceInterfaces";
import { convertDateToYYYYMMDD } from "@/utils/utilities";

export const MODEL_NAME = "ProviderSource";
export const TABLE_NAME = "provider_sources";
export const PLURALIZED_MODEL_NAME = "ProviderSources";
export const VERBOSE_MODEL_NAME = "Provider Source";
export const PLURALIZED_VERBOSE_MODEL_NAME = "Provider Sources";
export const DEFAULT_SORT_BY = "name";
export const DEFAULT_FILTERS: Partial<ProviderSourceFormikFilter> = { 
