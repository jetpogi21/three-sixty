...
import { EmployerOfficeFormikFilter } from "@/interfaces/EmployerOfficeInterfaces";
import { convertDateToYYYYMMDD } from "@/utils/utilities";

export const MODEL_NAME = "EmployerOffice";
export const TABLE_NAME = "employer_offices";
export const PLURALIZED_MODEL_NAME = "EmployerOffices";
export const VERBOSE_MODEL_NAME = "Employer Office";
export const PLURALIZED_VERBOSE_MODEL_NAME = "Employer Offices";
export const DEFAULT_SORT_BY = "name";
export const DEFAULT_FILTERS: Partial<EmployerOfficeFormikFilter> = { 
