...
import { PriorityFormikFilter } from "@/interfaces/PriorityInterfaces";
import { convertDateToYYYYMMDD } from "@/utils/utilities";

export const MODEL_NAME = "Priority";
export const TABLE_NAME = "priorities";
export const PLURALIZED_MODEL_NAME = "Priorities";
export const VERBOSE_MODEL_NAME = "Priority";
export const PLURALIZED_VERBOSE_MODEL_NAME = "Priorities";
export const DEFAULT_SORT_BY = "name";
export const DEFAULT_FILTERS: Partial<PriorityFormikFilter> = { 
