...
import { StageFormikFilter } from "@/interfaces/StageInterfaces";
import { convertDateToYYYYMMDD } from "@/utils/utilities";

export const MODEL_NAME = "Stage";
export const TABLE_NAME = "stages";
export const PLURALIZED_MODEL_NAME = "Stages";
export const VERBOSE_MODEL_NAME = "Stage";
export const PLURALIZED_VERBOSE_MODEL_NAME = "Stages";
export const DEFAULT_SORT_BY = "name";
export const DEFAULT_FILTERS: Partial<StageFormikFilter> = { 
