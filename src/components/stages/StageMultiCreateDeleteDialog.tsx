...
export function StageMultiCreateDeleteDialog() {
  ...
  const [currentData, resetRowSelection, setCurrentData] = useStageStore((state) => [
    state.currentData,
  ...
  const mutateStage = () => {
    mutate && mutate({ deletedStages: recordsToDelete });
  };
