...
export function StatusMultiCreateDeleteDialog() {
  ...
  const [currentData, resetRowSelection, setCurrentData] = useStatusStore((state) => [
    state.currentData,
  ...
  const mutateStatus = () => {
    mutate && mutate({ deletedStatus: recordsToDelete });
  };
