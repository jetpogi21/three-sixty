...
export function PositionMultiCreateDeleteDialog() {
  ...
  const [currentData, resetRowSelection, setCurrentData] = usePositionStore((state) => [
    state.currentData,
  ...
  const mutatePosition = () => {
    mutate && mutate({ deletedPositions: recordsToDelete });
  };
