...
export function PriorityMultiCreateDeleteDialog() {
  ...
  const [currentData, resetRowSelection, setCurrentData] = usePriorityStore((state) => [
    state.currentData,
  ...
  const mutatePriority = () => {
    mutate && mutate({ deletedPriorities: recordsToDelete });
  };
