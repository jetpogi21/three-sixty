...
export function ProviderMultiCreateDeleteDialog() {
  ...
  const [currentData, resetRowSelection, setCurrentData] = useProviderStore(
    (state) => [
      state.currentData,
  ...
  const mutateProvider = () => {
    mutate && mutate({ deletedProviders: recordsToDelete });
  };
