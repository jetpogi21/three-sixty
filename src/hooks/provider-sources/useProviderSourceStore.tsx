...
import { DEFAULT_SORT_BY } from "@/utils/constants/ProviderSourceConstants";
...
type State = {
  ...
  currentData: ProviderSourceFormikShape[];
  isUpdating: boolean;
  sort: string;
  hasUpdate: boolean;
};
...
type Actions = {
  ...
  setCurrentData: (item: ProviderSourceFormikShape[]) => void;
...
const useProviderSourceStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
