...
import { DEFAULT_SORT_BY } from "@/utils/constants/PriorityConstants";
...
type State = {
  ...
  currentData: PriorityFormikShape[];
  isUpdating: boolean;
  sort: string;
  hasUpdate: boolean;
};
...
type Actions = {
  ...
  setCurrentData: (item: PriorityFormikShape[]) => void;
...
const usePriorityStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
