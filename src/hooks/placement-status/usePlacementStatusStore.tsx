...
import { DEFAULT_SORT_BY } from "@/utils/constants/PlacementStatusConstants";
...
type State = {
  ...
  currentData: PlacementStatusFormikShape[];
  isUpdating: boolean;
  sort: string;
  hasUpdate: boolean;
};
...
type Actions = {
  ...
  setCurrentData: (item: PlacementStatusFormikShape[]) => void;
...
const usePlacementStatusStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
...
export { usePlacementStatusStore };
