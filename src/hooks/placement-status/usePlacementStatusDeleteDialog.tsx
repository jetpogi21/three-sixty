...
type State = {
  ...
  mutate?: (payload: PlacementStatusDeletePayload) => void;
  setMutate: (mutate: (payload: PlacementStatusDeletePayload) => void) => void;
};

// Create your store, which includes both state and (optionally) actions
const usePlacementStatusDeleteDialog = create<State>((set) => ({
  recordsToDelete: [],
...
export { usePlacementStatusDeleteDialog };
