...
import { DEFAULT_SORT_BY } from "@/utils/constants/CandidateConstants";
...
type Actions = {
  ...
  setCurrentData: (item: CandidateModel[]) => void;
...
const useCandidateStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
