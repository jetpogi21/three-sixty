...
import { DEFAULT_SORT_BY } from "@/utils/constants/StatusConstants";
...
type Actions = {
  ...
  setCurrentData: (item: StatusFormikShape[]) => void;
...
const useStatusStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
