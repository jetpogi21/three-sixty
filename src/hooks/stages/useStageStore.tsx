...
import { DEFAULT_SORT_BY } from "@/utils/constants/StageConstants";
...
type Actions = {
  ...
  setCurrentData: (item: StageFormikShape[]) => void;
...
const useStageStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
