...
import { DEFAULT_SORT_BY } from "@/utils/constants/ProviderConstants";
...
type State = {
  ...
  currentData: ProviderFormikShape[];
  isUpdating: boolean;
  sort: string;
  hasUpdate: boolean;
};
...
type Actions = {
  ...
  setCurrentData: (item: ProviderFormikShape[]) => void;
...
const useProviderStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
