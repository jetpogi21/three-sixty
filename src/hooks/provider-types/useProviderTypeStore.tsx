...
import { DEFAULT_SORT_BY } from "@/utils/constants/ProviderTypeConstants";
...
type State = {
  ...
  currentData: ProviderTypeFormikShape[];
  isUpdating: boolean;
  sort: string;
  hasUpdate: boolean;
};
...
type Actions = {
  ...
  setCurrentData: (item: ProviderTypeFormikShape[]) => void;
...
const useProviderTypeStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
