...
import { DEFAULT_SORT_BY } from "@/utils/constants/GroupSiteConstants";
...
type State = {
  ...
  currentData: GroupSiteFormikShape[];
  isUpdating: boolean;
  sort: string;
  hasUpdate: boolean;
};
...
type Actions = {
  ...
  setCurrentData: (item: GroupSiteFormikShape[]) => void;
...
const useGroupSiteStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
