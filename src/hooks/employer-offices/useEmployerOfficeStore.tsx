...
import { DEFAULT_SORT_BY } from "@/utils/constants/EmployerOfficeConstants";
...
type State = {
  ...
  currentData: EmployerOfficeFormikShape[];
  isUpdating: boolean;
  sort: string;
  hasUpdate: boolean;
};
...
type Actions = {
  ...
  setCurrentData: (item: EmployerOfficeFormikShape[]) => void;
...
const useEmployerOfficeStore = create<State & Actions>((set) => ({
  recordCount: 0,
  page: 0,
  cursor: "",
  lastPage: 0,
