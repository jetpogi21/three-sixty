...
function getCandidateSQL(
  ...
  const fields: ([string, string] | string)[] =
    ...
    [
      ...
      "source",
      ["candidate_state_id", "candidateStateID"],
      ...
      "email",
      "employer",
      ["employer_office_id", "employerOfficeID"],
      ["employer_state_id", "employerStateID"],
      ["employer_candidate_id", "employerCandidateID"],
      ["employer_candidate_owner", "employerCandidateOwner"],
      ["group_site_id", "groupSiteID"],
      ...
      ["placement_status_id", "placementStatusID"],
      ["360archive", "archive"],
...
export const GET = async (req: Request) => {
  ...
  data = reduceResult(data as any, []) as unknown as CandidateModel[];
